        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="about-store">
                 Đây là trang Web làm ra nhằm phục vụ Học tập Môn điện toán đám mây vui lòng không trao đổi mua bán
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Đại học Thủ Dầu Một - Bình Dương</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0868655861</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:minhquangalaxys@gmail.com">minhquangalaxys@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
